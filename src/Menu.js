        ...
        <>
            ...
            <aside id="sidebar" className="sidebar">
                <ul className="sidebar-nav" id="sidebar-nav">
                    ...
                    <li className="nav-item shadow-sm">
                       <Link className="nav-link collapsed" to="doctor-update-profile.html">
                            <i className="fa fa-home fa-2x" />
                    ...
                    <li className="nav-item shadow-sm">
                       <Link className="nav-link collapsed" to="doctor-assitant.html">
                            <i className="fa fa-home fa-2x" />
                            <span>My Assitants</span>
                       </Link>
                    </li>
                    <li className="nav-item shadow-sm">
                       <Link className="nav-link collapsed" to="doctor-appointment.html">
                            <i className="fa fa-home fa-2x" />
                            <span>My Appointments</span>
                       </Link>
                    </li>
                    <li className="nav-item shadow-sm">
                       <Link className="nav-link collapsed" to="assitant-home.html">
                            <i className="fa fa-home fa-2x" />
                            <span>Home</span>
                       </Link>
                    </li>
                    <li className="nav-item shadow-sm">
                       <Link className="nav-link collapsed" to="change-password.html">
                            <i className="fa fa-home fa-2x" />
